...
import {
  ...
  updateUserAsync,
} from "../../features/Authorise/authSlice";
import {
  createOrderAsync,
  selectCurrOrder,
...
function Checkout() {
  ...
  const handleOrder = () => {
    const order = {
      ...
      payMode,
      selectedAdd,
      status: "pending", // other status can be delivered ,received etc.
    };
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
          <div className="lg:col-span-3">
            <form
              className="bg-white px-5 py-7 mt-24"
              noValidate
