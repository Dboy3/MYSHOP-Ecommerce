...
import { restCartAsync } from "../../features/ShoppingCart/cartSlice";
...
function OrderSuccess() {
  ...
  useEffect(() => {
    dispatch(restCartAsync(user.id));
    dispatch(resetOrder())
  }, [dispatch , user]);
    ...
    <>
      ...
      <main className="grid place-items-center bg-white px-6 py-24 sm:py-32 lg:px-8">
        <div className="text-center">
          <p className="text-base font-semibold text-indigo-600">Huraahhhh</p>
